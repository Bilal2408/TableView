...
class ViewController: UIViewController {
    ...
    //Unser Datasource
    var games = ["Far Cry 6", "Battlefield 2042", "God of War", "Rocket League"]
    ...
    override func viewDidLoad() {
        ...
        //leeres UIView um die TableView zu "kürzen"
    ...
    @IBAction func addButtonFunction(_ sender: UIBarButtonItem) {
        
        //Anlegend des Textfields für die Benutzung im Alert
